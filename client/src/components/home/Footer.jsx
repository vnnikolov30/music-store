...
function Footer() {
  return (
    <div>
      <footer className="bg-white lg:grid lg:grid-cols-5 dark:bg-gray-900 py-6">
        <div className="relative block h-32 lg:col-span-2 lg:h-full">
          <img
            src="https://images.unsplash.com/photo-1562092083-bf2848da4bcd?q=80&w=1888&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          ...
          <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
                &copy; 2024. MusiCo. All rights reserved.
              </p>
            </div>
          </div>
        </div>
